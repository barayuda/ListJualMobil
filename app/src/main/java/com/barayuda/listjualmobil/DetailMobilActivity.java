...
public class DetailMobilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtDetail.setText(Html.fromHtml("<h1>"+item.getTitle()+"</h1> Harga: "+item.getHarga()+"<br/> Lokasi: <strong>"+item.getLokasi()+"</strong>"));

        Picasso.with(DetailMobilActivity.this).load(item.getImage())
